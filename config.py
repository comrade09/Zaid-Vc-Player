...
BOT_NAME = getenv("BOT_NAME", "ShinobuXMusic")
...
BOT_USERNAME = getenv("BOT_USERNAME", "@ShinobuMusic_bot")
OWNER_ID = getenv("OWNER_ID", "1030710940")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Cap")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "shinobu_support")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "shinobu_updates")
